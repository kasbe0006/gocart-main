<div align="center">
  <h1><img src="https://gocartshop.in/favicon.ico" width="20" height="20" alt="Velmora Favicon">
   Velmora</h1>
  <p>
...
Seed initial admin/store users (optional but recommended):
...
## 🧩 API Contract <a name="-api-contract"></a>

For backend integration planning and endpoint payload specs, see:
