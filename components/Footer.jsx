    ...
    const linkSections = [
        ...
        },
        {
            ...
            links: [
                ...
                { text: "Help Center", path: '/support', icon: null },
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+1-212-456-7890", path: '/support', icon: MailIcon },
                { text: "contact@example.com", path: '/support', icon: PhoneIcon },
                { text: "794 Francisco, 94102", path: '/support', icon: MapPinIcon }
            ]
        }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to Velmora, your ultimate destination for the latest and smartest gadgets. From smartphones and smartwatches to essential accessories, we bring you the best in innovation — all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © Velmora All Right Reserved.
                </p>
            </div>
        </footer>
    );
